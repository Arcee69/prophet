...
const Blogs = () => {
    ...
    useEffect(() => {
        ...
        dispatch(fetchBlogs({
            search,
            sort: statusFilter === "Newest First" ? "desc" : "asc", // Assuming "Newest First" means sort by created_at desc; adjust based on your API
            page: currentPage
        }))
    }, [search, statusFilter, currentPage, dispatch]) // Re-fetch on changes to these
