      ...
      {monthlyPlans?.map((item, index) => (
        <div key={index} className='p-6 md:p-[32px] flex flex-col gap-6 md:gap-[32px] rounded-2xl shadow'>
          <div className='flex flex-col gap-4'>
            ...
            <p className='text-GREY-_900 font-jost text-[40px] md:text-[60px] leading-[48px] md:leading-[72px] font-medium'>${item.price} <span className='text-GREY-_500 font-jost text-base font-medium leading-6'>per month</span></p>
            ...
            <div className='flex flex-col gap-4'>
              {item.features?.map((feature, idx) => (
                <div key={idx} className='flex items-center gap-3'>
                  ...
                  <p className='text-GREY-_500 text-[14px] md:text-base font-jost leading-6'>{feature}</p>
                </div>
              ))}
            </div>
          </div>
